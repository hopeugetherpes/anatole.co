      ...
      <div className="max-w-2xl mx-auto">
        ...
        <footer className="mt-16 pt-8 border-t border-gray-200 text-center text-sm text-gray-500 font-archivo">
          <div className="flex justify-center gap-4 mb-4">
            {/* Instagram */}
            <a href="https://instagram.anatole.co/" className="hover:opacity-80 transition-opacity">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="#FCE1E1" />
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="none" stroke="#D66565" strokeWidth="2" />
                <circle cx="12" cy="12" r="3" fill="none" stroke="#D66565" strokeWidth="2" />
                <circle cx="17.5" cy="6.5" r="1" fill="#D66565" />
              </svg>
            </a>

            {/* Signal */}
            <a href="https://signal.anatole.co/" className="hover:opacity-80 transition-opacity">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="10" fill="none" stroke="#4E84F2" strokeWidth="1.5" strokeDasharray="2 2" />
                <circle cx="12" cy="10" r="6" fill="#4E84F2" />
                <path
                  d="M8 16l2-2h4c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2z"
                  fill="#4E84F2"
                />
                <path d="M8 16l-2 2v-2z" fill="#4E84F2" />
              </svg>
            </a>

            {/* Mastodon */}
            <a href="https://mastodon.social/@hopeugetherpes" className="hover:opacity-80 transition-opacity">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="#6364FF" />
                <path
                  d="M8.5 7c-1.5 0-2.5 1-2.5 2.5v3c0 1.5 1 2.5 2.5 2.5h1c1.5 0 2.5-1 2.5-2.5v-3c0-1.5-1-2.5-2.5-2.5h-1zm5 0c-1.5 0-2.5 1-2.5 2.5v3c0 1.5 1 2.5 2.5 2.5h1c1.5 0 2.5-1 2.5-2.5v-3c0-1.5-1-2.5-2.5-2.5h-1zm-5 8c0 1.5 1 2.5 2.5 2.5h1v2c0 1-1 2-2 2s-2-1-2-2v-2.5z"
                  fill="white"
                />
            ...
            {/* GitHub */}
            <a href="https://github.com/hopeugetherpes" className="hover:opacity-80 transition-opacity">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path
            ...
            <a href="#" className="hover:opacity-80 transition-opacity">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path
                  d="M12 2.5c-2.5 2.5-5 5-5 7.5 0 1.5 1 2.5 2.5 2.5s2.5-1 2.5-2.5c0-2.5 2.5-5 5-7.5-2.5 2.5-5 5-5 7.5 0 1.5 1 2.5 2.5 2.5s2.5-1 2.5-2.5z"
                  fill="#00BDFE"
                />
                <path
                  d="M7 12c0 2.5 2.5 5 5 7.5 2.5-2.5 5-5 5-7.5-1.5 1.5-3.5 2.5-5 2.5s-3.5-1-5-2.5z"
                  fill="#00BDFE"
                />
              </svg>
            </a>
